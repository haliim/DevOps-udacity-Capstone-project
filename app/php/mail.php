...
$toEmail = "ah.hesham93@gmail.com"; // Replace Your Email Address
...
$fromEmail = "no-reply@halim.website";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Halim"; // Replace Company Name
...
$recaptcha_secret = '6LfGTPgZAAAAAMczSneN8K1eOAunVZWBqvmIDSkX'; // Your Google reCaptcha Secret


/* --------------------------------------------
  // Subject
--------------------------------------------- */
$subject = "Form Response from Halim.Website"; // Your Subject
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	$success = "Thank you for contacting me and will be in touch with you very soon."; // Success Message
